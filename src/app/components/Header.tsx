    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="text-2xl font-bold text-white hover:text-red-500 transition-colors flex items-center gap-2">
            <span className="text-2xl">🏪</span>
            <span className="hidden sm:inline">Vendr</span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* User Account */}
            <Link to="/account" className="hidden sm:flex items-center justify-center w-10 h-10 rounded-xl hover:bg-white/10 transition-colors">
