          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-5 border border-[#e4e4e7]">
                <p className="text-[#0a0a0a] text-sm font-medium mb-3">Hours</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3.5 py-2.5 border border-[#e4e4e7] rounded-lg bg-white text-[#0a0a0a] focus:outline-none focus:border-[#0a0a0a] placeholder-[#a1a1aa] text-sm transition-colors"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3.5 py-2.5 border border-[#e4e4e7] rounded-lg bg-white text-[#0a0a0a] focus:outline-none focus:border-[#0a0a0a] text-sm appearance-none transition-colors"
                    >
                  ...
                  <div>
                    <label className="block text-sm text-[#71717a] mb-1.5">Message</label>
                    <textarea
                      name="message"
                      ...
                      required
                      rows={5}
                      className="w-full px-3.5 py-2.5 border border-[#e4e4e7] rounded-lg bg-white text-[#0a0a0a] focus:outline-none focus:border-[#0a0a0a] placeholder-[#a1a1aa] text-sm resize-none transition-colors"
                  ...
                  <button
                    type="submit"
                    className="bg-[#0a0a0a] text-white font-medium py-2.5 px-6 rounded-lg hover:bg-[#2a2a2a] transition-colors text-sm"
                  >
                    Send message
                  </button>
                </form>
